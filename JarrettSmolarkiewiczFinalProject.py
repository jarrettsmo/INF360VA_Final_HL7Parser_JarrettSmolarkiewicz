...
20 points - Project is well documented (use block and line comments to describe the program as a whole, individual functions, and major areas of the project).
20 points - Uses logging module: 
                - Includes import logging module.
                - Includes setup for basic config.
                - Must have combination of logging.debug and logging.critical statements used appropriately. 
                - Can use any additional logging level (example: logging.warning).
20 points - Uses Object Oriented Programming: 
                - Points can be earned by creating custom classes and modules OR through use of third party modules. 
                - If using third party modules, comments MUST INCLUDE the packages that need to be installed (probably from pip).
---------------------------------------------------------
